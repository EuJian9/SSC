<?php
	...
	**************************************************************************/
	...
	class calendar
	{
			...
			while($this->row = mysqli_fetch_array($this->result, MYSQL_ASSOC))
			{
				 ...
				 if($js == true)
				 {
					 ...
					 if($event_url == 'false' && $event_allDay == 'false')
					 {
						...
						$build_json = array('id' => $event_id, 'title' => $event_title, 'description' => $event_description,'venue' => $event_venue, 'start' => $event_start, 'end' => $event_end, 'allDay' => $event_allDay, 'color' => $event_color);
						...
						array_push($this->json_array, $build_json);
						 ...
						 // Stores Each Database Record To An Array (Without URL)
						$build_json = array('id' => $event_id, 'title' => $event_title, 'description' => $event_description,'venue' => $event_venue, 'start' => $event_start, 'end' => $event_end, 'color' => $event_color);
						...
						$build_json = array('id' => $event_id, 'title' => $event_title, 'description' => $event_description,'venue' => $event_venue, 'start' => $event_start, 'end' => $event_end, 'allDay' => $event_allDay, 'color' => $event_color, 'url' => $event_url);
						...
						array_push($this->json_array, $build_json);
						 ...
						 if($event_allDay == 'false') {
							...
							// Stores Each Database Record To An Array
							$build_json = array('id' => $event_id, 'title' => $event_title, 'description' => $event_description,'venue' => $event_venue, 'start' => $event_start, 'end' => $event_end, 'color' => $event_color, 'url' => $event_url);
					 ...
					 if($event_url == 'false' && $event_allDay == 'false')
					 {
						...
						array_push($this->json_array, $build_json);
						 ...
						 if($event_allDay == 'false' && substr($event_url, -4, 1) == '.' || substr($event_url, -3, 1) == '.') { // domain top level checking
							...
							// Stores Each Database Record To An Array
							$build_json = array('id' => $event_id, 'title' => $event_title, 'description' => $event_description,'venue' => $event_venue, 'start' => $event_start, 'end' => $event_end,  'allDay' => $event_allDay, 'color' => $event_color, 'url' => $event_url . $event_id);
							...
							// Stores Each Database Record To An Array
							$build_json = array('id' => $event_id, 'title' => $event_title, 'description' => $event_description,'venue' => $event_venue, 'start' => $event_start, 'end' => $event_end, 'color' => $event_color, 'url' => $event_url . $event_id);
		...
		* Returns true
		*/
		public function updates($id, $title, $description,$venue, $url)
		{
			// The update query
			$query = sprintf('UPDATE %s
									SET
						...
						',
										...
										mysqli_real_escape_string($this->connection, htmlentities($venue)),
		...
		* Returns true
		*/
		public function addEvent($title, $description,$venue, $start_date, $start_time, $end_date, $end_time, $color, $allDay, $url, $extra=false)
		{
			// Convert Date Time
		...
		* Returns true
		*/
		public function icalExport($id, $title, $description,$venue, $start_date, $end_date, $url=false)
		{
